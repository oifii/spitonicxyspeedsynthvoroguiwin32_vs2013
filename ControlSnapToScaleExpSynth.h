...
#ifndef ControlSnapToScaleExpSynth_h
#define ControlSnapToScaleExpSynth_h

#include "Tonic.h"

using namespace Tonic;

class ControlSnapToScaleExpSynth : public Synth{
public:
	ControlSnapToScaleExpSynth(){
...
//TONIC_REGISTER_SYNTH(ControlSnapToScaleExpSynth);
